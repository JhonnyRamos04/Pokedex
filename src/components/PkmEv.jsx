                ...
                <ul className="flex flex-wrap justify-center items-center gap-2 mt-4">
                    {
                        newEvolution.map(evo => (
                            <li className="flex justify-between items-center w-44 md:w-auto md:flex-col p-3 bg-black/20 rounded-2xl border-2 border-white" key={evo.name}>
                                <img className=" size-16 md:size-32" src={`${evo.sprite}`} alt={evo.name} />
                                <div className="flex flex-col items-center justify-center font-bold text-base md:text-lg">
